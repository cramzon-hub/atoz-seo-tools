...
class SSPNEWS {
    ...
    static function Ssql_exec ($db, $bindings, $sql=null )
    {
        ...
        while ($arr = $stmt->fetch(PDO::FETCH_ASSOC)) {
            ...
            $result[$loop]['actions'] = '<a class="btn btn-danger btn-xs" onclick="return confirm(\'Are you sure you want to delete this item?\');" title="Delete" href='.adminLink($controller.'/delete/'.$myid,true).'> <i class="fa fa-trash-o"></i> &nbsp; Delete </a>';
